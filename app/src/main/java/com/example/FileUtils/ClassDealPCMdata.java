...
public class ClassDealPCMdata{
	 ...
	 * 历史数据
	 */
	private short[] historyData = null;
	/**
	 * 计算的指标类型     0>烈度  1>脉冲  2>欲度 3>峰值  4>峭度 5>波形
	 */
	private int arithmeticType;
	
	public ClassDealPCMdata(short[] historyData, int arithmeticType){
	 ...
	 * @return
	 */
	private float deal_Dimensionless_Parameter(short[] colleteData ,int arithmeticType){
