...
//	private ArrayList<Map<String, Object>> infos = null;
	...
	private ArrayList<Map<String, Object>> fileListInfo;
	
	SurfaceView sfv;
	Paint mPaint;
	private TextView historyDateTextView = null;private String historyFileDate = null;
...
//	private int width = 0,height=0;private boolean hasMeasured = false; 
	...
	protected void onCreate(Bundle savedInstanceState) {
		...
		mShowDataDrawer.setSet_mMenuSize(950);                                           //设置drawer大小
	...
	private void initView(){
		show_and_hide_view = (ImageView)findViewById(R.id.show_and_hide_view);
	...
	private void initList(String path){
		...
		//重新初始化一个
		infos = new LinkedList<Map<String,Object>>();
...
//			mReturn.setCompoundDrawables(drawable, null, null, null);
	...
	private void initUI(){
		...
		showButton = (ImageButton)findViewById(R.id.showWaveBtn);
		showButton.setOnClickListener(this);
		lastDataButton = (ImageButton)findViewById(R.id.lastDataBtn);
		lastDataButton.setOnClickListener(this);
		nextDataButton = (ImageButton)findViewById(R.id.nextDataBtn);
		nextDataButton.setOnClickListener(this);
		
		historyDateTextView = (TextView)findViewById(R.id.history_date_TextView);
		collection_pointTextView = (TextView)findViewById(R.id.collection_point);
		originalDataListView = (ListView)findViewById(R.id.originalDataListView);
		...
		mChartLayout = (LinearLayout)findViewById(R.id.historyChartView);
	...
	private void getCurAllFile(String curDirPath){
		fileListInfo = new ArrayList<Map<String,Object>>();
	...
	private short[] getImportData(String fileName){
		...
		//保存当前路径所有文件名
		getCurAllFile(historyFile.getParent().toString());
