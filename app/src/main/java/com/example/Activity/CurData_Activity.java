...
import com.example.Activity.DimensionlessData_Activity.ReadDimensionlessdata_Thread;
...
public class CurData_Activity extends Activity implements OnClickListener{
	 ...
	 * 报告列表
	 */
	private List<DimensionlessReport> report_list = new ArrayList<DimensionlessReport>();
...
//		setContentView(R.layout.cur_data_activity);
	...
	class readCurData_From_File implements Runnable{
		...
		public void run() {
			// TODO Auto-generated method stub
			curData = getNewestSecondData();
			curDimensionlissData = getNewestSecondDimensionlessData();
	 ...
	 * param fileName
	 */
	private short[] getNewestSecondData(){
		File historyFile = null;
		try {
			historyFile = new File(getNewestFile(GlobleVariable.SD_CARD_PATH+"/"+GlobleVariable.DATA_SAVE_DIR+"/"+GlobleVariable.CUR_ORIGINAL_DATA_PER_1S));
		} catch (Exception e) {
	 ...
	 * param fileName
	 */
	private float[] getNewestSecondDimensionlessData(){
		File historyFile = null;
		try {
			historyFile = new File(getNewestFile(GlobleVariable.SD_CARD_PATH+"/"+GlobleVariable.DATA_SAVE_DIR+"/"+GlobleVariable.CUR_DIMENSION_LESS_PER_1S));
	...
	private void updateReportList(){
		if (listViewAdapter==null && report_list!=null) {
	...
	private void initUI(){
		...
		//无量纲指标值标签
		dataValueTextView1 = (TextView)findViewById(R.id.bottomData1);
		dataValueTextView2 = (TextView)findViewById(R.id.bottomData2);
		dataValueTextView3 = (TextView)findViewById(R.id.bottomData3);
		dataValueTextView4 = (TextView)findViewById(R.id.bottomData4);
		dataValueTextView5 = (TextView)findViewById(R.id.bottomData5);
		dataValueTextView6 = (TextView)findViewById(R.id.bottomData6);
		//采集提示标签
		collctionTips = (TextView)findViewById(R.id.collction_tips);
		
		//chartView
		labelTextView = (TextView)findViewById(R.id.curdata_label_TextView);
		mChartLayout = (LinearLayout)findViewById(R.id.curDataChartView);
		timeChart = new TimeChart(Color.CYAN, PointStyle.CIRCLE, "实时采样值", "采样点", "采样值");
		
		//底部功能按钮
		report_Btn = (ImageButton)findViewById(R.id.report_imageBtn);
		report_Btn.setOnClickListener(this);
		collction_set_Btn = (ImageButton)findViewById(R.id.colletion_set_imageBtn);
		collction_set_Btn.setOnClickListener(this);
		pauseLabel = (TextView)findViewById(R.id.pause_and_startLabel);
		pause_Btn = (ImageButton)findViewById(R.id.pause_and_start_imageBtn);
		pause_Btn.setOnClickListener(this);
		//底部功能按钮标志线
		pause_underLine = (ImageView)findViewById(R.id.pauseUnderLine);
		set_underLine = (ImageView)findViewById(R.id.setUnderLine);
		report_underLine = (ImageView)findViewById(R.id.reportUnderLine);
...
/****************************************************系统回调函数*************************************************************************/  
    public void start_all_TimerTask(){
	...
	public void onClick(View view) {
		...
		case R.id.startButton:
			...
			startButton.setTextColor(Color.rgb(60, 66, 68));
		...
		case R.id.colletion_set_imageBtn:
			pieMenu.show(collction_set_Btn,61,250);
